...
The session should not be long lived, this is not something like a cookie that you store for a long time. It should be generated for each user session and it should change if the user closes the tab/window.