...
Once you have installed the script, you can create a pageview on your website and check the session data on the [dashboard](https://visitorquery.com/dashboard).