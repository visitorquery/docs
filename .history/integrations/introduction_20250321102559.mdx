...
The main script will be loaded automatically inti the page and the hook will take care of the rest. For a complete example and more information please refer to the hook’s npm page.