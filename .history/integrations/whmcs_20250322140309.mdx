...
Even if behind a proxy or VPN, a user might be legitimate. Instead of banning we decided to allow our users to enable or disable certain payment gateways.
