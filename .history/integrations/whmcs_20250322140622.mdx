...
- **Minimum Confidence**: This is the minimum confidence level that you want to use for the checks. The higher the confidence, the more accurate the checks are.