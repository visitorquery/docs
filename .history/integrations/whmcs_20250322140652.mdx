...
- **Minimum Confidence**: This is the minimum confidence level that triggers a block. If the check marks a session as a proxy with a confidence level below this, the user will be allowed to proceed.