...
If you want to allow a user to continue, you can go to the detections page and Invalidate the detection. This will allow the user to proceed as if they were not detected as a proxy.